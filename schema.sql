...
CREATE SCHEMA IF NOT EXISTS phazbot AUTHORIZATION phazbot; -- Change this line's "bot"s if your bot postgres username is not bot!
    ...
    -- might add timed bans here in the future
    -- for softbans only at the moment
    ...
    guildid BIGINT PRIMARY KEY,
    colormode VARCHAR(9) DEFAULT 'communal',
